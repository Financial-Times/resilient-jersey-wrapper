...
public class EndpointConfiguration {
		...
		if (rawNodes == null || rawNodes.isEmpty()) {
			...
			for (String rawNode: rawNodes) {
			  ...
			  if (matcher.matches()) {
			    ...
			    if (endpointProtocol != null) {
			      ...
			      if (protocol == null) {
			        protocol = endpointProtocol;
	                  ...
	                  throw new IllegalArgumentException(String.format("All nodes in a group must use the same protocol (%s conflicts with %s)", protocol, rawNode));
			      }
			    }
                ...
                throw new IllegalArgumentException(String.format("`%s` is not a valid endpoint value.", rawNode));
              }
			}
			return nodes;
		}
    ...
    private List<String> produceNodes(List<SimpleEndpointConfiguration> simpleEndpointConfigurations) {
