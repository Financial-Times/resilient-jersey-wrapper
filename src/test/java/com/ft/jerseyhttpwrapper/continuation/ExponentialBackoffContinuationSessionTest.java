...
public class ExponentialBackoffContinuationSessionTest {
  ...
  @Mock HostAndPortProvider mockProvider;

  @Mock private Iterator<HostAndPort> firstMockProviderIterator;

  @Mock private Iterator<HostAndPort> secondMockProviderIterator;

  @Mock private Iterator<HostAndPort> thirdMockProviderIterator;
  ...
  public void shouldStopIteratingIfInterupted() {
    ...
    final ExponentialBackoffContinuationSession session =
        new ExponentialBackoffContinuationSession(
            someHost, mockProvider, new ExponentialBackoffContinuationPolicy(100, 100));
    ...
    // the minimum delay was 100ms, which implies the second attempt was observable but we should
    // not have survived to see a third item returned.
  ...
  public void shouldBackOffExponentially() {
    ...
    final ExponentialBackoffContinuationSession session =
        new ExponentialBackoffContinuationSession(
            someHost, mockProvider, new ExponentialBackoffContinuationPolicy(4, 100));
  ...
  public void shouldLoopThroughHostsListMultipleTimesUpToConfiguredLimit() {
    ...
    when(mockProvider.iterator(someHost))
        .thenReturn(
            firstMockProviderIterator, secondMockProviderIterator, thirdMockProviderIterator);
    ...
    final ExponentialBackoffContinuationSession session =
        new ExponentialBackoffContinuationSession(
            someHost, mockProvider, new ExponentialBackoffContinuationPolicy(4, 1));
  ...
  public void shouldTryOnceIfSoConfigured() {
    ...
    final ExponentialBackoffContinuationSession session =
        new ExponentialBackoffContinuationSession(
            someHost, mockProvider, new ExponentialBackoffContinuationPolicy(1, 100));
