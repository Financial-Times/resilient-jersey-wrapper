...
public class EndpointConfigurationTest {
	...
	public void shouldNotFailOnNullNodes() {
		new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), null, null);
	}

	@Test
	public void shouldNotFailOnEmptyNodes() {
		new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Collections.<String>emptyList(), Collections.<String>emptyList());
	}

	@Test
	public void shouldHaveNoNodesWhenNullNodes() {
		EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), null, null);
	...
	public void shouldHaveNoNodesWhenEmptyNodes() {
		EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Collections.<String>emptyList(), Collections.<String>emptyList());
		assertThat(configuration.getPrimaryNodes().size(), equalTo(0));
		assertThat(configuration.getSecondaryNodes().size(), equalTo(0));
	}
	...
	public void shouldHaveOnePrimaryNodeWhenOneNodeGiven() {
		EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("host:80:81"), Collections.<String>emptyList());
	...
	public void shouldHaveOneSecondaryNodeWhenOneNodeGiven() {
		EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Collections.<String>emptyList(), Arrays.asList("host:80:81"));
		assertThat(configuration.getPrimaryNodes().size(), equalTo(0));
	...
	public void shouldHaveOneSecondaryNodeAndCorrectAdminPortWhenOneNodeGivenAndNoAdminPortGiven() {
		EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Collections.<String>emptyList(), Arrays.asList("host:80"));
		assertThat(configuration.getPrimaryNodes().size(), equalTo(0));
		assertThat(configuration.getSecondaryNodes().size(), equalTo(1));
	...
	public void shouldHaveTwoPrimaryNodesWhenTwoNodesGiven() {
		EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("host:80:81", "host2:90:91"), Collections.<String>emptyList());
	...
	public void shouldHaveThreePrimaryNodesWhenTwoNodesGivenWeirdWhiteSpace() {
		EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList(" host:80:81 ", "host2:90:91 ", "host3:100:101"), Collections.<String>emptyList());
	...
	public void shouldAcceptResilienceStrategyOption() throws Exception {
		...
		assertThat(readEndpointConfig.getResilienceStrategy(),is(ResilienceStrategy.LOAD_BALANCED_IP_STRATEGY));
	}
    ...
    public void thatDefaultsToHttpOnPort80() {
        EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("host1", "host2:90:91"), Collections.<String>emptyList());
        assertThat(configuration.getPrimaryNodes().size(), equalTo(2));
        assertThat(configuration.getSecondaryNodes().size(), equalTo(0));
    ...
    public void thatDefaultsToPort80ForHttp() {
        EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("http://host1", "host2:90:91"), Collections.<String>emptyList());
        assertThat(configuration.getPrimaryNodes().size(), equalTo(2));
        assertThat(configuration.getSecondaryNodes().size(), equalTo(0));
    ...
    public void thatHttpsIsSupported() {
        EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("https://host:8443:8444", "host2:9090:9091"), Collections.<String>emptyList());
        assertThat(configuration.getPrimaryNodes().size(), equalTo(2));
        assertThat(configuration.getSecondaryNodes().size(), equalTo(0));
    ...
    public void thatDefaultsToPort443ForHttps() {
        EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("https://host1", "host2:90:91"), Collections.<String>emptyList());
        assertThat(configuration.getPrimaryNodes().size(), equalTo(2));
        assertThat(configuration.getSecondaryNodes().size(), equalTo(0));
    ...
    public void thatMixedProtocolsAreNotAllowed() {
        new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("https://host1", "http://host2:90:91"), Collections.<String>emptyList());
    }

    @Test
    public void thatSecondaryNodeDefaultsToPrimaryNodesProtocol() {
        EndpointConfiguration configuration = new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList("https://host1"), Arrays.asList("host2"));
        assertThat(configuration.getPrimaryNodes().size(), equalTo(1));
        assertThat(configuration.getSecondaryNodes().size(), equalTo(1));
    ...
    public void thatMixedPrimaryAndSecondaryProtocolsAreNotAllowed() {
        new EndpointConfiguration(Optional.<String>absent(), Optional.<JerseyClientConfiguration>absent(), Optional.<String>absent(), Arrays.asList(/*http://*/"host1"), Arrays.asList("https://host2"));
    }
}
