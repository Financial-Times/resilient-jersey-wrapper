...
public class HostAndPortProviderBuilderTest {
	...
	public static final SimpleEndpointConfiguration HOST_A = new SimpleEndpointConfiguration("http", "a", 80, 8080);

	@Mock
	private HostAndPortIpResolver resolver;

	@Test
	public void empty_host_config_should_result_in_null_provider() throws Exception {
		final HostAndPortProvider hostAndPortProvider = new HostAndPortProviderBuilder(resolver)
	...
	@Test
	public void should_build_simple_host_and_port_provider_for_simple_failover_strategy() throws Exception {
		final HostAndPortProvider hostAndPortProvider = new HostAndPortProviderBuilder(resolver)
	...
	@Test
	public void should_build_random_host_and_port_provider_for_load_balanced_strategy() throws Exception {
		final HostAndPortProvider hostAndPortProvider = new HostAndPortProviderBuilder(resolver)
				.withStrategy(ResilienceStrategy.LOAD_BALANCED_STRATEGY)
				.withSimpleEndpointConfiguration(Arrays.asList(HOST_A))
				.build();
	...
	@Test
	public void should_build_random_ip_host_and_port_provider_for_load_balanced_ip_strategy() throws Exception {
		final HostAndPortProvider hostAndPortProvider = new HostAndPortProviderBuilder(resolver)
