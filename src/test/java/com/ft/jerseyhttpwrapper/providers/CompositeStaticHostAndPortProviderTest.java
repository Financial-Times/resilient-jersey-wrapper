...
public class CompositeStaticHostAndPortProviderTest {
    ...
    public void iteratorShouldReturnAllItems() throws Exception {
        final CompositeStaticHostAndPortProvider composite = new CompositeStaticHostAndPortProvider(primary, secondary);
    ...
    public void shouldReportFailedHostToCorrectComposite() throws Exception {
        ...
        final CompositeStaticHostAndPortProvider composite = new CompositeStaticHostAndPortProvider(surveilledPrimary, surveilledSecondary);
